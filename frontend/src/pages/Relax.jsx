...
export default function Relax({ nav, onSelect }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0d0d0d" }}>
        ...
        <div style={{
          ...
          <div style={{ position: "relative", padding: "0 40px 48px" }}>
            <div style={{
              ...
              marginBottom: 10, textTransform: "uppercase", fontFamily: "monospace"
            }}>
              Featured · {featured.series_name}
            </div>
            <h1 style={{ fontSize: 38, fontWeight: 700, lineHeight: 1.1, marginBottom: 16, maxWidth: 500 }}>
              {featured.title}
            </h1>
      ...
      <div style={{ padding: "32px 40px" }}>
        <div style={{
          fontSize: 11, letterSpacing: 3, color: "#555",
          marginBottom: 20, textTransform: "uppercase", fontFamily: "monospace"
        }}>
      ...
      <div style={{
        ...
        {video.creator_tier === "new" && (
          <div style={{
            ...
            fontSize: 9, fontWeight: 700, padding: "3px 7px",
            borderRadius: 3, border: "1px solid rgba(255,204,68,0.3)"
          }}>NEW</div>
        )}
      </div>
